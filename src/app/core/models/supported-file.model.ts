...
export const SUPPORTED_FORMATS: readonly SupportedFormatInfo[] = [
  ...
  { format: 'doc', extension: 'doc', label: 'DOC', note: 'Legacy Word' },
  { format: 'ppt', extension: 'ppt', label: 'PPT', note: 'Legacy slides' },
  { format: 'xlsx', extension: 'xls', label: 'XLS', note: 'Legacy sheets' },
