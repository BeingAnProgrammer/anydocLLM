...
/**
 * The landing page's animated "drop a document, watch it convert" demo.
 * Split out from LandingPageComponent purely to give this widget its own
 * component style budget — it has no data in or out.
 */
@Component({
  selector: 'app-preview-demo',
  templateUrl: './preview-demo.html',
